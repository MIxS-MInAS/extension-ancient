# Term: enrichment probe design description (capture_probe_desc) 
...
<b>NOTE:</b> does not include [Combinations](combinations.md) (of checklists and extensions) that use capture_probe_desc.
