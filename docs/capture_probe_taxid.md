# Term: genomic capture probe taxonomic IDs (capture_probe_taxid) 
...
<b>NOTE:</b> does not include [Combinations](combinations.md) (of checklists and extensions) that use capture_probe_taxid.
